...
namespace Enneto.Controls
{

    ///Este codigo no se utiliza en ninguna momento
    public class StepProgresBarControl : StackLayout
    {
        Button _lastStepSelected;

        public static readonly BindableProperty StepsProperty =
       BindableProperty.Create(nameof(Steps), typeof(int), typeof(StepProgresBarControl), 0);

        public static readonly BindableProperty StepSelectedProperty =
            BindableProperty.Create(nameof(StepSelected), typeof(int), typeof(StepProgresBarControl), 0, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty StepColorProperty =
            BindableProperty.Create(nameof(StepColor), typeof(Color), typeof(StepProgresBarControl), Color.Black, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty UnselectedStepColorProperty =
            BindableProperty.Create(nameof(UnselectedStepColor), typeof(Color), typeof(StepProgresBarControl), Color.Transparent, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty DividersEnabledProperty =
            BindableProperty.Create(nameof(DividersEnabled), typeof(bool), typeof(StepProgresBarControl), true, defaultBindingMode: BindingMode.TwoWay);

        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create(nameof(ItemsSource), typeof(IEnumerable), typeof(StepProgresBarControl), default(IEnumerable<object>),
        ...
        {
            var itemsLayout = (StepProgresBarControl)bindable;
